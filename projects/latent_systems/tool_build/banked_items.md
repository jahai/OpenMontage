...
**Updated:** 2026-05-14 Day 2 of Phase 3 sprint (Day 2 substrate LANDED commit 62793d3: Migration 0004 additive — notes_md_state + cross_ai_captures +7 cols + hero_promotions +4 cols [F5 schema gap closure] + audio_assets table; F5 hero promotion atomic action per F5_MODAL_UX_DRAFT.md v1.2 [dispatcher.hero_promote/un_promote + POST /audit/render/<id>/promote + /un_promote + 14-scenario test_hero_promotion.py]; audio_assets.py module + 12-scenario test_audio_assets.py for rough-cut player prereq; cascade order fix on hero_promotions/verdicts to OR-on-render_id for hashed-promotion_id derivation; full suite 96 passed + 1 documented skip; production state.db row counts byte-identical pre/post pytest. F5 modal UI deferred to Day 6 per original Wave 1 plan. Rubric calibration integration from RUBRIC_CALIBRATION_SCRATCH_2026_05_13.md → docs/AUDIT_RUBRICS_v1_0.md PENDING Joseph.) Prior 2026-05-13 Day 1: Phase 2.5 conftest fix LANDED commit 8be45e3 — tmp_path-isolated DB fixture per Pattern #8 reinforcement #3 + Banking principle #7; 15 test files migrated; test-runner-quirk RESOLVED. Workstream 1B rubric scratch authored commit 2729160. Prior 2026-05-09: Phase 2 acceptance bridge COMPLETE (rubric a0bc668, Wave B real-fire, e2e debrief); Daily-usability sprint a32572f 2026-05-08; Phase 3 v0.4 amendments f7e0604/1065d75/ae48115/2411811. **Cleanup-leak class banking 2026-05-09** — Pattern #8 reinforcement #3 (test_audit_consult audit_sessions + test_vision_anthropic api_calls leaks); Banking principle #7 added; api_calls cleanup commit a52ec90.
